...
Widget desktopView(BuildContext context, double dartValue, double flutterValue, double graphicDesignValue, double uiUxDesignValue, bool allIsSelected, bool webIsSelected, bool mobileIsSelected) {
  return Padding(
    ...
    child: ListView(
      children: [
        ...
        aboutMeItem(dartValue, flutterValue, graphicDesignValue, uiUxDesignValue),
        const SizedBox(height: 10),
        services(),
        const SizedBox(height: 10),
        project(allIsSelected: allIsSelected, webIsSelected: webIsSelected, mobileIsSelected: mobileIsSelected),
        const SizedBox(height: 10),
